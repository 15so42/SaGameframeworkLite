...
public struct 
    ...
    ///
    ///</summary>
    public int aoeEntityTypeId;

    ///<summary>
    ///aoe是否碰撞到阻挡就摧毁了（removed），如果不是，移动就是smooth的，如果移动的话……
    ///</summary>
    public bool reduceHpOnHitObstacle;
    ...
    public AoeModel(
        string id, int aoeEntityTypeId, string[] tags, float tickTime, bool reduceHpOnHitObstacle,
        ...
        this.id = id;
        this.aoeEntityTypeId = aoeEntityTypeId;
        this.tags = tags;
        this.tickTime = tickTime;
        this.reduceHpOnHitObstacle = reduceHpOnHitObstacle;
...
public class AoeMoveInfo{
    ...
    public AoeMoveInfo(UnitMoveType unitMoveType, Vector3 velocity, Quaternion rotation){
