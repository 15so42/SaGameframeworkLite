...
public class BulletLauncher{
    ...
    public BulletLauncher(
        BulletModel model, GameObject caster, Vector3 firePosition, Quaternion localRotation, float speed, float duration,
        float canHitAfterCreated = 0,bool hitCaster=false,bool hitAlly=false,bool hitFoe=true,
        BulletTween tween = null,BulletTweenCondition bulletTweenCondition=null, BulletTargettingFunction targetFunc = null, bool useFireDegree = false,
        ...
        this.hitFoe = hitFoe;
        this.tween = tween;
        this.bulletTweenCondition = bulletTweenCondition;
...
public struct BulletModel{
    ...
    public BulletModel(
        string id, int bulletEntityId, int muzzleId,int soundId,
        string onCreate = "",
        ...
        MoveMethod moveMethod = MoveMethod.TranslatePosWithPenetration, float moveSpeedParam=10f,
        int hitTimes = 1, float sameTargetDelay = 0.1f, bool isTrigger=true,bool useGravity=false
    ){
        this.id = id;
        ...
        this.moveSpeedParam = moveSpeedParam;
...
///子弹被创建的事件
///</summary>
public delegate void BulletOnCreate(BulletState bullet);
...
///<param name="target">被击中的角色</param>
///<summary>
public delegate void BulletOnHit(BulletState bullet, ChaState target);

/// <summary>
/// 子弹命中碰撞体的时候触发的事件
/// </summary>
public delegate void BulletOnHitObstacle(BulletState bullet, Collider target);
...
///<return>返回这一时间点上的速度和偏移，Vector3就是正常速度正常前进</return>
///</summary>
public delegate Vector3 BulletTween(float t, BulletState bullet, GameObject target);


/// <summary>
/// 返回是否使用Tween进行移动，在使用物理子弹时只需要设置一个初速度后就应该关闭Tween的控制了
/// </summary>
public delegate bool BulletTweenCondition(float t, BulletState bullet, GameObject target);
